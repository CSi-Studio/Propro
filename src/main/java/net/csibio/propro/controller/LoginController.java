...
import net.csibio.propro.domain.bean.message.ApplyMessage;
import net.csibio.propro.domain.bean.message.DingtalkMessage;
...
import net.csibio.propro.component.HttpClient;
